...
class DoubleScissorsVideoPage extends StatefulWidget {
  const DoubleScissorsVideoPage({super.key});

  @override
  State<DoubleScissorsVideoPage> createState() =>
      _DoubleScissorsVideoPageState();
}
